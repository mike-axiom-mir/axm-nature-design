# Animation east-rear shared-driver diagnostic loop 003

## Scope

This Animation successor consumes the exact five-socket Rigging shared-driver composition from PR #14 head `bbc6584accb91204b02b8d11193768556da036e5` and gives that already-defined kinematic parameter one bounded time-domain diagnostic loop.
...
Clip: `east-rear-five-socket-shared-driver-diagnostic-loop-003`.
