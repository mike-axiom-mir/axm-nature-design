#!/usr/bin/env python3
"""Build retained evidence for the Geometry-rebound east/rear root socket."""
...
from axm_nature_design.rear_tree_rigging_geometry_rebind import RESULT, evaluate
...
def main() -> int:
    ...
    if evidence["result"] != RESULT:
        raise SystemExit(f"Rigging receiver-rebind evidence failed: {evidence['result']}")
