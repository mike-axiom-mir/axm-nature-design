...
CONTRACT_PATH = ROOT / "contracts" / "east-rear-shared-driver-animation-loop-004.json"
...
class RearTreeAnimationSharedDriverTests(unittest.TestCase):
    ...
    def test_contract_keeps_downstream_authority_false(self):
        ...
        self.assertEqual(contract["rigging_owner"]["head"], "b4b480b415047fea90b4740f7702ced0dba9142d")
